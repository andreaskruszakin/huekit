...
const apiRows = [
  ...
  { name: "savePaletteAs / loadPalette", type: "fn", desc: "Create or load a palette; tracks activePaletteId." },
  { name: "updateActivePalette", type: "fn", desc: "Overwrite the loaded palette with current var values." },
  { name: "renamePalette / deletePalette", type: "fn", desc: "Edit palette names or remove entries from localStorage." },
